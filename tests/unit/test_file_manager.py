...
class TestFileManager(unittest.TestCase):
    ...
    def test_create_timestamped_dir(self, mock_exists, mock_mkdir, mock_datetime):
        """test_create_timestamped_dir: Verifies the creation of a directory with a correctly formatted timestamp name."""
    ...
    def test_save_text_chunk_writes_content(self, mock_exists, mocked_file):
        """test_save_text_chunk_writes_content: Verifies writing text chunk content to a file."""
    ...
    def test_cleanup_temp_directories(self, mock_is_dir, mock_exists, mock_rmtree):
        """test_cleanup_temp_directories: Verifies the cleanup of temporary directories."""
        dirs = ["/tmp/1", "/tmp/2"]
    ...
    def test_ensure_directory_exists(self, mock_mkdir):
        """test_ensure_directory_exists: Verifies recursive creation of directories."""
    ...
    def test_save_text_chunk_missing_dir(self, mock_exists):
        """test_save_text_chunk_missing_dir: Verifies error handling when trying to save a chunk in a non-existent directory."""
